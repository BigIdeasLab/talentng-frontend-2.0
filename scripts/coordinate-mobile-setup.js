...
function coordinateMobileSetup() {
  ...
  console.log('   netsh advfirewall firewall add rule name="Backend Dev" dir=in action=allow protocol=TCP localport=3000');
  console.log('   netsh advfirewall firewall add rule name="Frontend Dev" dir=in action=allow protocol=TCP localport=8080');
