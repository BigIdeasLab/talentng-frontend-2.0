...
import { deleteTalentProfile } from "@/lib/api/users";
  ...
  return (
    <div className="h-screen bg-white flex flex-col">
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between py-3 gap-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[12px] font-inter-tight text-[#525866]">
                      Permanently delete your talent profile and data
                    </p>
                  </div>
                </div>
                <Button
      ...
      <DeleteConfirmationModal
        ...
        description="This will permanently remove all your talent data, applications, and portfolio items. You can still use your other profiles if you have any. This action cannot be undone."
        confirmationText="delete talent profile"
