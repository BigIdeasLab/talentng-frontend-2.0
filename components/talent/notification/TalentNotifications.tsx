...
import { TalentNotificationsSkeleton } from "@/components/skeletons/NotificationsSkeleton";
...
export function TalentNotifications({
  ...
  if (loading) {
    return <TalentNotificationsSkeleton />;
  }
          ...
          >
            ...
            >
              ...
              <div className="flex-1 min-w-0 py-0.5">
                <p className="text-sm md:text-[13px] leading-snug">
                  <span
                    className={`${isUnread ? "font-semibold" : "font-medium"} text-gray-900 break-words`}
                  >
                    {formatted.title}
                  </span>{" "}
                  <span className="font-normal text-gray-700 break-words">
                    {formatted.message}
                  </span>
                </p>
                ...
                <div className="flex flex-col gap-0.5 mt-1.5">
                  <div className="flex items-center gap-1.5">
                    <p className="text-sm md:text-[11px] text-gray-500">
                      {formatted.timestamp}
                    </p>
                    {formatted.deliveryStatus === "failed" && (
                      <span className="text-sm md:text-[10px] text-red-500 ml-auto">
                        Failed
                      </span>
                    )}
                  </div>
                  ...
                  {formatted.action && (
                    <button
                      ...
                      className="text-sm md:text-[10px] text-blue-600 hover:text-blue-700 font-medium inline-flex items-center gap-0.5 mt-1 min-h-[44px] md:min-h-0 -ml-2 pl-2 md:ml-0 md:pl-0"
                    >
