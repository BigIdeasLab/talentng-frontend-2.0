...
export const MobileProgressiveHeader = forwardRef<MobileProgressiveHeaderRef, MobileProgressiveHeaderProps>(
  function MobileProgressiveHeader({ header, tabs, children }, ref) {
    ...
    return (
      <div ref={scrollContainerRef} className="h-full overflow-y-auto scrollbar-styled">
