    ...
    <div className="flex w-full h-full min-h-[320px] flex-col items-center justify-center gap-[28px] py-[30px]">
      ...
      {buttonText && (
        <button
          ...
          className="flex h-[44px] px-[20px] py-[14px] justify-center items-center gap-[8px] rounded-[40px] border border-[#5C30FF] bg-[#5C30FF] hover:bg-[#4a24d6] transition-colors"
        >
