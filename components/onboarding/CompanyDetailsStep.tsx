...
const operatingModels = ["Fully Remote", "Hybrid", "On-site"];
...
export const CompanyDetailsStep = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!formData.operatingModel.trim()) {
      newErrors.operatingModel = "Operating model is required";
    }
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-[13px]">
              ...
              <div className="flex flex-col gap-[13px]">
                ...
                <select
                  ...
                  className={`h-[53px] rounded-[10px] border-0 bg-[#F5F5F5] px-[15px] text-[15px] font-[Inter_Tight] text-black focus:ring-2 focus:ring-purple-600 focus:outline-none appearance-none cursor-pointer ${
                    errors.companySize ? "ring-2 ring-red-500" : ""
                  }`}
                >
              ...
              <div className="flex flex-col gap-[13px]">
                ...
                <select
                  ...
                  onChange={handleChange}
                  className={`h-[53px] rounded-[10px] border-0 bg-[#F5F5F5] px-[15px] text-[15px] font-[Inter_Tight] text-black focus:ring-2 focus:ring-purple-600 focus:outline-none appearance-none cursor-pointer ${
                    errors.companyStage ? "ring-2 ring-red-500" : ""
                  }`}
                >
              ...
              <div className="flex flex-col gap-[13px]">
                ...
                <select
                  ...
                  onChange={handleChange}
                  className={`h-[53px] rounded-[10px] border-0 bg-[#F5F5F5] px-[15px] text-[15px] font-[Inter_Tight] text-black focus:ring-2 focus:ring-purple-600 focus:outline-none appearance-none cursor-pointer ${
                    errors.operatingModel ? "ring-2 ring-red-500" : ""
                  }`}
                >
                ...
                <div className="relative w-[290px] h-[195px] flex items-center justify-center">
                  ...
                  >
                    ...
                    <path
                      ...
                      fillOpacity="0.2"
                    />
                    <g filter="url(#filter1_d_2026_6807)">
                      <path
                    ...
                    <circle
                      ...
                      cy="143.902"
                      r="62.6779"
                      fill="url(#pattern1_2026_6807)"
                    />
                    <defs>
                      <filter
                        id="filter1_d_2026_6807"
                        x="49.0745"
                        y="-5.72205e-06"
                        width="285.853"
                        height="285.49"
                      ...
                      <pattern
                        id="pattern1_2026_6807"
                        patternContentUnits="objectBoundingBox"
                        width="1"
                        height="1"
                      >
                        <use
                          xlinkHref="#image1_2026_6807"
