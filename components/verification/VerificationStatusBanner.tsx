...
export function VerificationStatusBanner({
  ...
  const config = {
    not_started: {
      ...
      message: 'Get a verified badge and build trust with talent. Verification takes 2-3 business days.',
    ...
    pending: {
      ...
      message: 'Your application is being reviewed. We\'ll notify you once the review is complete.',
    ...
    approved: {
      ...
      title: 'Verified ✓',
      message: 'Your business is verified! Your verified badge is now displayed on your profile.',
    ...
    rejected: {
      ...
      message: rejectionReason || 'Your verification was not approved. Please review the feedback and resubmit.',
