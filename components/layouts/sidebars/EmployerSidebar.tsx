...
const TelescopeIcon = () => (
  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M15.8333 18.3333L11.6667 10.8333L7.5 18.3333" stroke="#525866" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M13.2663 3.33325L5.85596 7.71317C5.03743 8.19696 4.75698 9.26842 5.22957 10.1064L6.08523 11.6237C6.55781 12.4616 7.60446 12.7487 8.423 12.2649L15.8333 7.88499" stroke="#525866" strokeWidth="1.25" strokeLinejoin="round"/>
    <path d="M13.5163 3.71318C13.1398 3.06073 13.3632 2.22643 14.0154 1.84974C14.6675 1.47304 15.5014 1.69659 15.8779 2.34905L18.1504 6.28698C18.5269 6.93944 18.3035 7.77373 17.6514 8.15043C16.9992 8.52716 16.1653 8.30357 15.7888 7.65111L13.5163 3.71318Z" stroke="#525866" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M1.66663 11.8871L2.28177 13.0268M2.28177 13.0268L2.89691 14.1667M2.28177 13.0268L5.41663 11.25" stroke="#525866" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);

const WorkIcon = () => (
  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M1.66663 11.6666C1.66663 9.32584 1.66663 8.15543 2.22839 7.31469C2.47159 6.95072 2.78409 6.63822 3.14806 6.39502C3.9888 5.83325 5.15919 5.83325 7.49996 5.83325H12.5C14.8407 5.83325 16.0111 5.83325 16.8519 6.39502C17.2158 6.63822 17.5283 6.95072 17.7715 7.31469C18.3333 8.15543 18.3333 9.32584 18.3333 11.6666C18.3333 14.0073 18.3333 15.1778 17.7715 16.0185C17.5283 16.3824 17.2158 16.6949 16.8519 16.9382C16.0111 17.4999 14.8407 17.4999 12.5 17.4999H7.49996C5.15919 17.4999 3.9888 17.4999 3.14806 16.9382C2.78409 16.6949 2.47159 16.3824 2.22839 16.0185C1.66663 15.1778 1.66663 14.0073 1.66663 11.6666Z" stroke="#525866" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M13.3333 5.83333C13.3333 4.26198 13.3333 3.47631 12.8451 2.98816C12.357 2.5 11.5713 2.5 9.99996 2.5C8.42863 2.5 7.64293 2.5 7.15478 2.98816C6.66663 3.47631 6.66663 4.26198 6.66663 5.83333" stroke="#525866" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M5 9.16675L5.54331 9.33508C8.40425 10.2217 11.5957 10.2217 14.4567 9.33508L15 9.16675M10 10.0001V11.6667" stroke="#525866" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);

const StudentCardIcon = () => (
  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M11.6666 2.91675C14.8093 2.91675 16.3807 2.91675 17.357 3.95408C18.3333 4.99141 18.3333 6.66096 18.3333 10.0001C18.3333 13.3392 18.3333 15.0087 17.357 16.0461C16.3807 17.0834 14.8093 17.0834 11.6666 17.0834H8.33329C5.19059 17.0834 3.61925 17.0834 2.64293 16.0461C1.66663 15.0087 1.66663 13.3392 1.66663 10.0001C1.66663 6.66096 1.66663 4.99141 2.64293 3.95408C3.61925 2.91675 5.19059 2.91675 8.33329 2.91675H11.6666Z" stroke="#525866" strokeWidth="1.25" strokeLinejoin="round"/>
    <path d="M4.16663 12.9165C5.50717 11.1353 8.62821 11.0382 9.99996 12.9165M8.54079 8.54157C8.54079 9.34699 7.88789 9.9999 7.08248 9.9999C6.27707 9.9999 5.62414 9.34699 5.62414 8.54157C5.62414 7.73617 6.27707 7.08325 7.08248 7.08325C7.88789 7.08325 8.54079 7.73617 8.54079 8.54157Z" stroke="#525866" strokeWidth="1.25" strokeLinecap="round"/>
    <path d="M12.5 7.91675H15.8333" stroke="#525866" strokeWidth="1.25" strokeLinecap="round"/>
...
export function EmployerSidebar({
  ...
  return (
    <aside className="flex w-[271px] flex-col bg-white border-r border-[#E1E4EA] h-screen">
      ...
      {/* Content Container */}
      <div className="flex-1 px-[20px] py-[10px] flex flex-col gap-[425px] overflow-y-auto">
        <div className="flex flex-col gap-[12px]">
          {/* Profile Switcher */}
          <ProfileSwitcher profile={profile} userRole="Employer" />
              ...
              return (
                ...
                >
                  ...
                  {item.badge !== undefined && item.badge > 0 && (
                    <div className="ml-auto flex items-center justify-center w-[20px] h-[20px] rounded-full bg-[#E63C23]">
