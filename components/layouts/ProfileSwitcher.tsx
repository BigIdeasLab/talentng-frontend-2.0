              ...
              >
                <div className="flex items-center gap-[10px]">
                  <div 
                    className="w-[42px] h-[42px] rounded-full bg-cover bg-center flex-shrink-0"
                    style={{ 
                      backgroundImage: 'url(https://api.builder.io/api/v1/image/assets/TEMP/e1692b6d1a7ac011b334889f33c4fab122cab305?width=84)'
                    }}
                  />
