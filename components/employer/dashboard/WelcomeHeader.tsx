    ...
    <div className="relative w-full rounded-2xl bg-gradient-to-br from-[#0D9F5C]/90 to-[#0D9F5C] overflow-hidden p-4 md:p-6 flex-shrink-0">
      ...
      <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
        <div>
          ...
          <h1 className="text-white text-[18px] font-inter-tight font-bold mb-3 flex items-center gap-2">
            Welcome back, {companyName}
            <Link
              href="/verification"
              className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md bg-white/10 hover:bg-white/20 transition-colors text-[11px] font-medium"
            >
