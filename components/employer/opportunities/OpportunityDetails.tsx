...
export function OpportunityDetails({ opportunityId }: OpportunityDetailsProps) {
  ...
  const typeConfigKey = opportunity.type?.toLowerCase() === "parttime" ? "parttime" : opportunity.type?.toLowerCase() || "job";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_460px] gap-6 lg:gap-7 overflow-y-auto flex-1">
            ...
            {opportunity.description && (
              <div className="flex flex-col gap-4">
                <h3 className="font-inter-tight text-[15px] font-medium text-black leading-[105%]">
                  About the {opportunity.employmentType || "Opportunity"}
                </h3>
            ...
            {opportunity.keyResponsibilities.length > 0 && (
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2">
                  {opportunity.keyResponsibilities.map((item, index) => (
          ...
          <div className="flex flex-col gap-2">
            <div className="border border-[#E1E4EA] rounded-[16px] p-5 flex flex-col gap-4 sticky top-0">
              ...
              {!isVolunteer && (opportunity.minBudget || opportunity.maxBudget) && (
              ...
              {(opportunity.workType || opportunity.employmentType) && (
                <div className="flex flex-col gap-2.5">
