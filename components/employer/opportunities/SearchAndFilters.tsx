...
export function SearchAndFilters({
  ...
  return (
    <>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            <button
              ...
              className={`h-[38px] px-[15px] py-[7px] flex items-center justify-center gap-[5px] rounded-[8px] transition-colors ${
                filterCount > 0
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button className="h-[38px] px-[15px] py-[7px] flex items-center justify-center gap-[5px] rounded-[8px] bg-[#F5F5F5] hover:bg-gray-100 transition-colors">
      ...
      <div className="flex flex-col gap-2 md:hidden">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative flex-1">
            <button
              onClick={onFilterClick}
              className={`h-[44px] px-[15px] py-[7px] flex items-center justify-center gap-[5px] rounded-[8px] w-full transition-colors ${
                filterCount > 0
                  ? "bg-[#8463FF0D] border border-[#8463FF] text-[#8463FF]"
                  : "bg-[#F5F5F5] hover:bg-gray-100 text-black border border-transparent"
              }`}
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <button className="h-[44px] px-[15px] py-[7px] flex items-center justify-center gap-[5px] rounded-[8px] flex-1 bg-[#F5F5F5] hover:bg-gray-100 transition-colors">
            <span className="text-[13px] font-normal font-inter-tight text-black">
              {sortBy === "newest"
                ? "Newest"
                : sortBy === "oldest"
