    ...
    <div className="space-y-4 p-4">
      ...
      <div className="border p-4 rounded">
        ...
        <p className="text-sm text-gray-600 mb-2">
          This content is visible only on mobile (&lt; 768px) and hidden on tablet and desktop (≥ 768px)
        </p>
        <ShowOnMobile>
          ...
          <HideOnMobile>
            <div className="bg-gray-100 p-3 rounded">
              ...
              <div className="flex space-x-2 mt-2">
                ...
                <button className="bg-blue-600 text-white px-4 py-2 rounded">Directions</button>
              </div>
            </div>
          </HideOnMobile>
        </div>
