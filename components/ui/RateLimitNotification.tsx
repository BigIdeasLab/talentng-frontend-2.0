      ...
      <div className="flex-1 min-w-0">
        ...
        {remainingTime && remainingTime > 0 && (
          <div className="mt-2 flex items-center gap-2">
            ...
            <span className="text-sm font-mono">{formattedTime} remaining</span>
          </div>
        )}

        {rateLimitInfo.type === "account_lockout" && (
          <div className={cn("text-xs mt-2", getTextColor())}>
            <strong>Security Notice:</strong> Your account has been temporarily
            locked to protect against unauthorized access attempts.
          </div>
        )}
      </div>
    </div>
