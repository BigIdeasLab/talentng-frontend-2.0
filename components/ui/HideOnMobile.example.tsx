    ...
    <div className="space-y-4 p-4">
      ...
      <div className="border p-4 rounded">
        ...
        <p className="text-sm text-gray-600 mb-2">
          This content is hidden on mobile (&lt; 768px) and visible on tablet and desktop (≥ 768px)
        </p>
        <HideOnMobile>
          <div className="bg-blue-100 p-3 rounded">
            <p>This content is only visible on tablet and desktop viewports!</p>
            <p className="text-sm text-gray-600">
              Resize your browser to see the visibility change at 768px breakpoint.
            </p>
          </div>
        </HideOnMobile>
      </div>
      ...
      <div className="border p-4 rounded">
        ...
        <HideOnMobile className="bg-green-50 border border-green-200 rounded-lg">
          <div className="p-3">
            <h4 className="font-medium text-green-800">Desktop/Tablet Only Feature</h4>
            <p className="text-green-700">
              This could be a detailed sidebar, advanced controls, or decorative elements
