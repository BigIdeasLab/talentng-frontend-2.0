...
describe("OrientationAdaptiveGrid", () => {
  ...
  it("should use landscape mobile columns in landscape orientation", () => {
    ...
    render(
      <OrientationAdaptiveGrid landscapeMobileCols={3} data-testid="grid">
        <div>Item 1</div>
        <div>Item 2</div>
      </OrientationAdaptiveGrid>,
    );
  ...
  it("should apply custom className", () => {
    render(
      <OrientationAdaptiveGrid className="custom-class" data-testid="grid">
        <div>Item 1</div>
      </OrientationAdaptiveGrid>,
    );
...
describe("OrientationAdaptiveModal", () => {
  ...
  it("should not apply full screen classes when disabled", () => {
    render(
      <OrientationAdaptiveModal fullScreenPortrait={false} data-testid="modal">
        <div>Content</div>
      </OrientationAdaptiveModal>,
    );
