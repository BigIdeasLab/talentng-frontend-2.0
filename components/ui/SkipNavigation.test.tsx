...
import { SkipNavigation, MainContent, NavigationWrapper, FooterWrapper } from './SkipNavigation';
...
describe('NavigationWrapper', () => {
  ...
  it('applies custom className', () => {
    render(<NavigationWrapper className="custom-nav">Test navigation</NavigationWrapper>);
...
describe('FooterWrapper', () => {
  ...
  it('applies custom className', () => {
    render(<FooterWrapper className="custom-footer">Test footer</FooterWrapper>);
