...
- [ ] **Button Placement**: Optimal button positioning for thumb reach
...
- [ ] **Breadcrumbs**: Navigation breadcrumbs where appropriate
- [ ] **Tab Navigation**: Horizontal tabs work well on wider screens
...
- [ ] **Action Buttons**: Button layouts optimized for larger screens
...
- [ ] **Confirmation Dialogs**: Dialogs positioned for easy thumb access
...
- [ ] **Grid Layouts**: Potential for 2-column card layouts in landscape
...
- [ ] **Detail Views**: More detailed information visible simultaneously
...
- [ ] **Button Placement**: Form buttons positioned for optimal thumb reach
...
- [ ] **Filter Forms**: More filter options visible simultaneously
...
- [ ] **Edge Interactions**: Actions near screen edges are accessible
...
- [ ] **Haptic Feedback**: Haptic feedback enhances interactions where available
...
- [ ] **Media Integration**: Better integration of media content
...
- [ ] **Thermal Management**: No overheating during extended use
...
- [ ] **Keyboard Handling**: Better keyboard handling with more screen space
...
- [ ] **Navigation**: Enhanced navigation options in landscape
...
- [ ] **Media Sharing**: Improved sharing capabilities
...
- [ ] **External Keyboards**: Bluetooth keyboard support where applicable
...
- [ ] **Sorting Options**: Enhanced sorting and organization features
...
- [ ] **Content Continuity**: Content viewing continuity across devices
...
**Expected**: [Expected behavior for large phone]
...
- [ ] **Edge Interaction Issues**: Problems with edge gestures or touches
- [ ] **Landscape Layout Problems**: Poor landscape mode optimization
...
- [ ] Excellent landscape mode experience
...
- [ ] Seamless transition between portrait and landscape modes
- [ ] Premium feel matching device quality
...
**Notes**: Large phones should provide an enhanced mobile experience that takes advantage of the additional screen real estate while maintaining excellent usability. Focus on both one-handed and two-handed usage patterns.