    ...
    test(`Responsive table - ${viewport.name}`, async ({ page }) => {
      await testPageResponsive(
        ...
        viewport,
        {
          mockAuth: true,
          userType: 'employer',
          waitForSelector: '[data-testid="applicants-table"], .applicants-table, .responsive-table',
          fullPage: true,
        }
      );
    });
    ...
    test(`Responsive grid - ${viewport.name}`, async ({ page }) => {
      await testPageResponsive(
        ...
        viewport,
        {
          mockAuth: true,
          userType: 'employer',
          waitForSelector: '[data-testid="talent-grid"], .talent-grid, .responsive-grid',
          fullPage: true,
        }
      );
    });
  ...
  test('Table transformation - mobile cards', async ({ page }) => {
    await testPageResponsive(
      ...
      VIEWPORTS.mobile,
      {
        mockAuth: true,
        userType: 'employer',
        waitForSelector: '[data-testid="mobile-table-card"], .mobile-table-card, .opportunity-card',
        fullPage: true,
      }
    );
  });
    ...
    await testPageResponsive(
      ...
      VIEWPORTS.tablet,
      {
        ...
        interactions: async (page) => {
          ...
          const table = page.locator('[data-testid="applicants-table"], .applicants-table, table').first();
  ...
  test('Responsive button groups - mobile vs desktop', async ({ page }) => {
    ...
    await testPageResponsive(
      ...
      VIEWPORTS.mobile,
      {
        mockAuth: true,
        userType: 'employer',
        waitForSelector: '[data-testid="form-buttons"], .form-buttons, .button-group',
    ...
    test(`Responsive stat cards - ${viewport.name}`, async ({ page }) => {
      await testPageResponsive(
        ...
        viewport,
        {
          mockAuth: true,
          userType: 'employer',
          waitForSelector: '[data-testid="stats-grid"], .stats-grid, .dashboard-stats',
    ...
    test(`Responsive charts - ${viewport.name}`, async ({ page }) => {
      await testPageResponsive(
        ...
        viewport,
        {
          mockAuth: true,
          userType: 'employer',
          waitForSelector: '[data-testid="weekly-overview-chart"], .chart-container, .recharts-wrapper',
    ...
    test(`Responsive search filters - ${viewport.name}`, async ({ page }) => {
      await testPageResponsive(
        ...
        viewport,
        {
          mockAuth: true,
          userType: 'employer',
          waitForSelector: '[data-testid="search-filters"], .search-filters, .filters-container',
  ...
  test('Responsive image gallery - mobile vs desktop', async ({ page }) => {
    await testPageResponsive(
      ...
      VIEWPORTS.mobile,
      {
        mockAuth: true,
        userType: 'employer',
        waitForSelector: '[data-testid="portfolio-gallery"], .portfolio-gallery, .works-grid',
        fullPage: true,
      }
    );
  });
    ...
    test(`Responsive typography - ${viewport.name}`, async ({ page }) => {
      await testPageResponsive(
        ...
        viewport,
        {
          mockAuth: true,
          userType: 'employer',
          waitForSelector: '[data-testid="opportunity-details"], .opportunity-details',
          fullPage: true,
        }
      );
    });
  ...
  test('Touch-friendly interactions - mobile', async ({ page }) => {
    await testPageResponsive(
      ...
      VIEWPORTS.mobile,
      {
        mockAuth: true,
        userType: 'employer',
        waitForSelector: '[data-testid="mobile-table-card"], .mobile-table-card',
        interactions: async (page) => {
          // Test touch target sizes by hovering/clicking
          const actionButton = page.locator('[data-testid="actions-dropdown"], .actions-menu-trigger').first();
