...
const OnboardingPage = () => {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-start md:justify-center px-4 py-6 md:py-8 lg:py-12 md:px-6 lg:px-8 w-full bg-white overflow-auto">
      {/* Background Image */}
      <img
      ...
      {/* Content */}
      <div className="bg-white rounded-[20px] md:rounded-[30px] shadow-lg overflow-hidden w-full max-w-5xl z-10 min-h-[500px] md:h-[600px] flex flex-col mt-4 md:mt-0">
        {currentStep === 1 && (
