...
function OpportunityCard({ opportunity }: { opportunity: Opportunity }) {
  ...
  return (
    <div className="relative">
      <div
        className={`flex flex-col items-center gap-6 pt-[15px] border border-[#E1E4EA] ${hasApplicationStatus ? "rounded-t-[20px] border-b-0" : "rounded-[20px]"} bg-white hover:shadow-md transition-shadow`}
      >
        {/* Card Content */}
