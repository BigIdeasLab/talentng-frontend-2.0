...
// Applied opportunities with application status
const appliedOpportunities: Opportunity[] = [
  {
    id: 'applied-1',
    posterName: 'Jamison Stoltenberg',
    posterAvatar: 'https://api.builder.io/api/v1/image/assets/TEMP/8231e6d86ed5fecb574745a8f76606ae8b1dcf75?width=80',
    date: 'Dec 2',
    type: 'internship',
    title: 'Data Science Intern',
    skills: ['Machine Learning', 'Data Visualization', 'Statistical Analysis', 'Python'],
    rate: '$25/hr',
    showActions: false,
  ...
  },
  {
    ...
    skills: ['Backend Development', 'User Research', 'Visual Design', 'Wireframing'],
    rate: '$75/hr',
    showActions: false,
  ...
  },
  {
    ...
    skills: ['User Interviews', 'Usability Testing', 'Research Methods', 'Analytics'],
    rate: '$280 / Month',
    showActions: false,
    applicationStatus: 'awaiting-review',
  },
...
function ApplicationStatusBanner({ status }: { status: ApplicationStatus }) {
  const statusConfig = {
    ...
    'hired': {
      ...
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M3 13.3333C3 13.3333 4.5 14 6.5 17C6.5 17 6.78485 16.5192 7.32133 15.7526M17 6C14.7085 7.14577 12.3119 9.55181 10.3879 11.8223" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M8 13.3333C8 13.3333 9.5 14 11.5 17C11.5 17 17 8.5 22 6" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      ),
    ...
    'not-hired': {
      ...
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M8 17C8.91212 15.7856 10.3643 15 12 15C13.6357 15 15.0879 15.7856 16 17" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M8.00897 9H8M16 9H15.991" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      ),
  ...
  return (
    <div
      className="flex items-center justify-center gap-2.5 py-6 px-14 rounded-b-[20px] border border-[#E1E4EA] border-t-0"
      style={{ backgroundColor: config.bgColor }}
    >
      <div className="flex items-center gap-2.5">
        {config.icon}
        <span className="text-[16px] font-medium font-inter-tight text-black text-center leading-[16.8px]">
          {config.message}
        </span>
      </div>
    </div>
