...
const typography = {
  ...
  sectionHeader: 'text-[12px] font-normal text-[rgba(0,0,0,0.30)] font-inter-tight',
...
```typescript
// BEFORE
className="w-full mt-[20px] px-6 py-3 min-h-[44px] rounded-full bg-[#1A1D2E] hover:bg-[#252A3E]"

// AFTER
className="w-full mt-[20px] px-6 py-3 min-h-[44px] rounded-full bg-[#181B25] hover:bg-[#2a2f3a]"
```
...
```typescript
// BEFORE
className="w-full h-[44px] rounded-full bg-[#181B25] hover:bg-[#2a2f3a] text-white font-normal text-[14px] font-inter-tight transition-colors flex-shrink-0 mt-[15px]"
